...
class Database {
    ...
    // connect first without SSL param if invalid key error --> useSSL=false&
    private static final String URL = "jdbc:mysql://localhost:" + PORT + "/" + DB_NAME + "?relaxAutoCommit=true";
